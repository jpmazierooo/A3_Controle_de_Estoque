...
/** Interface gráfica responsável por realizar o reajuste em lote dos preços dos produtos.
 * Permite aplicar tanto aumentos percentuais quanto descontos, com a opção de filtrar
 * por uma categoria específica ou aplicar a alteração a todos os produtos cadastrados.
 * @author João Pedro Maziero
*/
public class FrmAlterarPreco extends javax.swing.JFrame {
    
   /** Registrador de log (Logger) para capturar e registrar exceções e eventos da classe. */
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(FrmAlterarPreco.class.getName());

    /** Lista interna utilizada para armazenar o cache das categorias recuperadas do banco de dados. */
    private List<Categoria> categorias = new ArrayList<>();

    /**
     * Construtor padrão da classe.
     * Inicializa os componentes visuais gerados pela IDE, posiciona a janela no centro da tela,
     * carrega as categorias disponíveis no banco de dados e vincula manualmente o ouvinte 
     * de eventos do botão de aumento.
     */
    ...
    /**
     * Manipulador de evento acionado ao clicar no botão "Aumentar".
     * Direciona o fluxo para o processamento de reajuste com a flag positiva.

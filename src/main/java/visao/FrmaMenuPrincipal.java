...
/**
 * Interface Gráfica principal do sistema de Controle de Estoque.
 * <p>
 * Esta classe é responsável por exibir o menu principal e fornecer acesso
 * às funcionalidades de gerenciamento de produtos, categorias, preços,
...
public class FrmaMenuPrincipal extends javax.swing.JFrame {
    ...
    /**
     * Cria uma nova instância da tela FrmaMenuPrincipal.
     * Inicializa os componentes, centraliza a janela e desativa o redimensionamento.
     */
    ...
    /**
     * Inicializa os componentes da interface (botões, menus, labels).
     * <p>
     * Nota: Este método é gerado automaticamente pelo editor de formulários
     ...
     * @param evt O evento de ação disparado pelo botão.
     */
    ...
    /**
     * Abre a tela de Alteração de Preços.
     * @param evt O evento de ação disparado pelo botão.
     */
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        FrmAlterarPreco tela = new FrmAlterarPreco();
    ...
    /**
     * Abre a tela de Movimentação de Estoque (entrada/saída).
     * @param evt O evento de ação disparado pelo botão.
     */
    ...
    /**
     * Método de entrada da aplicação. Define o Look and Feel (Nimbus) 
     * e inicia a thread da interface gráfica.
